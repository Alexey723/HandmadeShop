...
import com.smaglyuk.handmadeshop.repositories.CartRepository;
import com.smaglyuk.handmadeshop.repositories.OrderRepository;
import com.smaglyuk.handmadeshop.repositories.ProductRepository;
import com.smaglyuk.handmadeshop.security.PersonDetails;
            ...
            if(!price.isEmpty()){
                if(price.equals("sorted_by_ascending_price")) {
                    ...
                    if(!contract.isEmpty()){
                        ...
                        if(contract.equals("candles")){
                            model.addAttribute("search_product", productRepository.findByTitleAndCategoryOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(ot), Float.parseFloat(Do), 1));
                        }else if (contract.equals("gypsum")) {
                            model.addAttribute("search_product", productRepository.findByTitleAndCategoryOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(ot), Float.parseFloat(Do), 2));
                        } else if (contract.equals("dreamCatcher")) {
